...
echo ""
echo "Next steps:"
echo "  1. Create an agent:  kroagent create <name>"
echo "  2. Edit agent.json to set port and workdir"
echo "  3. Add DNS entry pointing <name>.yourdomain to this machine"
echo "  4. Add nginx server block proxying to the agent's port"
echo "  5. Start the agent:  kroagent start <name>"
echo "  6. Authenticate Claude Code in the tmux session"
echo ""
